  ...
  namespace Postprocess
  {
    ...
    class ParticlePDF
    {
      public:
         ...
         */
        void fill_from_particle_range(const typename Particle::Generator::ParticleHandler<dim>::particle_iterator_range particle_range,
        ...
        void insert_kernel_sum_from_particle_range(
          ...
          const unsigned int n_particles_in_cell,
          const typename Particle::Generator::ParticleHandler<dim>::particle_iterator_range particle_range);
        ...
        */
         ...
         * point-density value.
         */
        types::particle_index get_max_particle();

        /**
         * Returns the index of the particle with whose position has the lowest
         * point-density value.
         */
        types::particle_index get_min_particle();
